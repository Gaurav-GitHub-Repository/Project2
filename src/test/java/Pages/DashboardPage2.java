...
//	By AddCart1 = By.xpath("//a[@class='btn btn-default add-to-cart' and @data-product-id='1']/self::a");
	...
	public void verifyCartSubscription()
	{
		...
		if(Success.equals("You have been successfully subscribed!"))
		{
			System.out.println("Subscription is verified");
		}
		else
...
/*	//Method for total price
	...
	public void totalPrice()
	{
		...
		System.out.println(Tab_TotalPrice);
		if(Tab_TotalPrice.equals("Rs. 500"))
		{
			System.out.println("Product total price is verified");
		}
		else
		{
			System.out.println("Product total price is not verified");
		}
	}		
	//Method to verify product page
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(View_Cart));
	...
	public void verifyProductInformation()
	{
		...
		if(ProductInfo.contains("Blue Top"))
		{
			System.out.println("Product1 details is verified");
		}
		else
		{
			System.out.println("Product1 details is not verified");
		}
	}
	...
	public void verifyDeletedProduct() throws InterruptedException
	{
		...
		if(Del_Product.equals("Cart is empty! Click here to buy products."))
		{
			System.out.println("Deleted Product is verified");
		}
		else
		{
			System.out.println("Deleted Product is not verified. Unable to match webelement text");
		}
	}
	...
	public void verifyCategory() throws InterruptedException
	{
		...
		{
			System.out.println("Category is verified");
		}
		else
		{
			System.out.println("Category is not verified. Unable to match webelement text");
		}
	}
	...
	public void verifyWomenDress()
	{
		...
		if(WomenPage.contains("ALL PRODUCTS"))
		{
			System.out.println("Women product page is verified");
		}
		else
		{
			System.out.println("Women product page is not verified. Unable to match webelement text");
		}
	}
	...
	public void verifyMenPage() throws InterruptedException
	{
	   ...
	   if(MenPage.equals("Men - Tshirts Products"))
	   {
		   System.out.println("Men product page is verified");
	   }
	   else
	   {
		   System.out.println("Men product page is not verified. Unable to match webelement text");
	   }
	}	
	...
	public void verifyPolo()
	{
		...
		if(Polo_Brand.contains("Brand - Polo Products"))
		{
			System.out.println("Polo brand is verified");
		}
		else
		{
			System.out.println("Polo brand is not verified. Unable to match webelement text");
		}
	}
	...
	public void verifyHM() throws InterruptedException
	{
		...
		if(HM_Brand.contains("Brand - H&M Products"))
		{
			System.out.println("H&M brand is verified");
		}
		else
		{
			System.out.println("H&M brand is not verified. Unable to match webelement text");
		}
	}	
	...
	public void verifySearchPage()
	{
		...
		if(Search_ProductPage.equals("SEARCHED PRODUCTS"))
		{
			System.out.println("Search product page is verified");
		}
		else
		{
			System.out.println("Search product page is not verified");
		}
	}
	...
	public void verifySearchProduct()
	{
		...
		System.out.println(Product);
		if(Product.equals("Premium Polo T-Shirts"))
		{
			System.out.println("Polo product is verified");
		}
		else
		{
			System.out.println("Polo product is not verified");
		}		
	}
	//Method to verify search product
