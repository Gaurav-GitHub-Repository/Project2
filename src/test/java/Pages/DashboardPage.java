...
public class DashboardPage extends Utility{
	...
	private static final Object LoggedName = null;
	WebDriver driver;
	...
	public void verifySubscription()
	{
		...
		if(subscription.equals("Subscription"))
		{
	...
	public void subscriptionSuccess()
	{
		...
		System.out.println(subscription);
		if(subscription.equals("You have been successfully subscribed!"))
		{
			System.out.println("Subscription message is verified");
		}
		else
		{
			System.out.println("Subscription message is not verified");
		}
	}
	...
	public void verifyAccountInformationForm() throws InterruptedException
	{
		...
		if(AccountInformationtext.equals("Enter_Account_Information_Form"))
		{
			System.out.println("Account_Information_Form is verified");
		}
		else
		{
			System.out.println("Account_Information_Form is not verified");
		}
	}	
...
//		driver.findElement(year).sendKeys(Keys.TAB);
	...
	public void verifyAccount() throws InterruptedException
	{
	  ...
	  if(Account.equals("ACCOUNT CREATED!"))
	  {
		  System.out.println("Account is verified and created");
	  }
	  else
	  {
...
//	    WebElement Ad_frame = driver.findElement(By.xpath("//iframe[@id='aswift_4']"));
	    WebElement Ad_frame = driver.findElement(By.xpath("//iframe[@title='Advertisement' and @id='ad_iframe']"));
	    driver.switchTo().frame(Ad_frame);
	    String Ad = driver.findElement(By.xpath("//div[text()='Ad']")).getText();
	    if(Ad.equals("Ad"))
	    {
	    	driver.findElement(Close_Ad).click();
	    }
    }
	public void verifyLoggedUsername() throws InterruptedException
	{
		...
		if(LoggedName.equals("Logged in as Pathange Gaurav"))
		{
			System.out.println("Logged in as username is verified");
		}
		else
		{
			System.out.println("Logged in as username is not verified");
		}
		}
		catch(TimeoutException e)
		{
...
//		}
	...
	public void verifyUsername() throws InterruptedException
	{
		...
		if(Username.contains(" Logged in as "))
		{
			System.out.println("TestCase4:Logged in username is verified");
		}
		else
		{
			System.out.println("TestCase4:Logged in username is not verified");
		}
	}
	...
	public void verifyContact()
	{
	  ...
	  if(Form.equals("Get In Touch"))
	  {
		  System.out.println("TestCase6:Get In Touch Form Text is verified");
	  }
	  else
	  {
		  System.out.println("TestCase6:Unable to capture element text.Get In Touch Form Text is not verified");
	  }
	}
	...
	public void verifySuccessMessage()
	{
	  ...
	  if(SubmittedForm.equals("Success! Your details have been submitted successfully."))
	  {
		  System.out.println("TestCase6:Success message is verified");
	  }
	  else
	  {
		  System.out.println("TestCase6:Unable to capture element text. Success message is not verified");
	  }
	}
	...
	public void verifyTestCase() throws InterruptedException
	{
		...
		if(Test_Case_Page.contains("Below is the list of test Cases for you to practice the Automation"))
		{
			System.out.println("TestCase7:Successfully navigated to test case page");
		}
		else
		{
			System.out.println("TestCase7:User is not navigated to test case page");
		}
	}
