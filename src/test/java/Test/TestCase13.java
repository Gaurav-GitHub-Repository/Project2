...
public class TestCase13 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		DashboardPage2 dashboardpage = new DashboardPage2(driver);
		dashboardpage.product();
		//TestCase4
		dashboardpage.scroll();
		dashboardpage.viewProduct();
		//TestCase5
		dashboardpage.verifyProductPage();
		//TestCase6
		dashboardpage.quantity("4");
		//TestCase7
		dashboardpage.addToCart();
		//TestCase8
		dashboardpage.ViewCart();
		//TestCase9
		dashboardpage.verifyProductCartPage();
		dashboardpage.verifyQuantity();
